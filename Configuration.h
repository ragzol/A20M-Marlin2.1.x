...
#define CONFIG_EXAMPLES_DIR "Geeetech/A20M (RZ)"
...
#define STRING_CONFIG_H_AUTHOR "(RZ, default config 2023.10)" // Who made the changes.
...
#define Z2_DRIVER_TYPE TMC2208_STANDALONE //rz
...
#define E2_DRIVER_TYPE TMC2208_STANDALONE //rz
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU       //rz  // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.3, 78.8, 409.9, 416.5 } //rz
 ...
 */
#define DEFAULT_ACCELERATION               500  //rz 1000  // X, Y, Z ... and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION       5000 //rz   2000  // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION        600 //rz   1000  // X, Y, Z ... acceleration for travel (non printing) moves
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.012 //rz 0.04  // (mm) Distance from real junction edge
...
#define USE_PROBE_FOR_Z_HOMING  //rz
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -18, -4, -1.11 } //{ -37, 0, -3.6 } rz
...
#define PROBING_MARGIN 25 //rz 13

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (120*60) //rz (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (6*60) //rz  (20*60)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 3) //rz 2
...
#define Z_MIN_PROBE_REPEATABILITY_TEST //rz
 ...
 */
//#define PROBING_HEATERS_OFF      //rz   // Turn heaters off when probing
#if ENABLED(PROBING_HEATERS_OFF)
  //#define WAIT_FOR_BED_HEATER     // Wait for bed to heat back up between probes (to improve accuracy)
  //#define WAIT_FOR_HOTEND         // Wait for hotend to heat back up between probes (to improve accuracy & prevent cold extrude)
#endif
//#define PROBING_FANS_OFF         //rz   // Turn fans off when probing
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
//#define DELAY_BEFORE_PROBING 100 //rz   // (ms) To prevent vibrations from triggering piezo sensors
...
#define ENABLE_LEVELING_AFTER_G28 //rz
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 3 //5 rz
...
#define HOMING_FEEDRATE_MM_M { (120*60), (120*60), (6*60) } //{ (80*60), (80*60), (20*60) } rz
...
//#define SKEW_CORRECTION
  ...
  //#define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_SKEW_FACTOR 0.0 //rz
    #define YZ_SKEW_FACTOR 0.0 //rz
  #endif
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors.  //rz
  #define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build.  //rz
#endif
...
//#define LCD_FEEDBACK_FREQUENCY_HZ 2028
...
#define ST7920_DELAY_1 DELAY_NS (200) //rz(125)
#define ST7920_DELAY_2 DELAY_NS (500) //rz(125)
#define ST7920_DELAY_3 DELAY_NS (500) //(125)
