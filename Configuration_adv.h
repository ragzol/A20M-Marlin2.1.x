 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  20 //rz 40               // (seconds)
 ...
 */
//#define INPUT_SHAPING_X //rz
//#define INPUT_SHAPING_Y //rz
  ...
  #endif
  #define SHAPING_MIN_FREQ  20        //rz By default the minimum of the shaping frequencies. Override to affect SRAM usage.
  #define SHAPING_MAX_STEPRATE 10000  //rz By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
  #define SHAPING_MENU                //rz Add a menu to the LCD to set shaping parameters.
#endif
...
#define LIN_ADVANCE
  ...
  #define EXPERIMENTAL_I2S_LA   //rz  Allow I2S_STEPPER_STREAM to be used with LA. Performance degrades as the LA step rate reaches ~20kHz.
#endif
